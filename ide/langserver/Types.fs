...
type Notification = 
    ...
    | DidShowedGraph of DidShowedGraphParams
...
type ServerCapabilities = {
    ...
    [<field: DataMember(Name="showGraphProvider", Order=18)>]
    showGraphProvider: bool
}
...
type ILanguageServer = 
    ...
    abstract member Rename: RenameParams -> unit
    abstract member CodeActions: CodeActionParams -> unit
    abstract member ShowGraph: ShowGraphParams -> string
